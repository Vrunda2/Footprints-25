  ...
  cybernetics: {
    ...
    data: [
      ...
      },
      {
        ...
        details: {
          info: [
            "Given on the day, participants will create a responsive web application using any technology stack of their choice (e.g., Figma, HTML, CSS, JavaScript, React, Vue, Angular, etc.).",
          ],
          rules: [
            "- Participants have to design a UI based on given problem statement",
            "- Judging Criteria: Creativity, responsiveness, user experience, functionality, clean code, and presentation.",
            ],
          price : ["- INR 200/-"],
          team: ["- Maximum 4"],
        },
    ...
    data: [
      {
        ...
        details: {
          info: [
            "Make an innovative design on a tote bag using given material and decorate it.",
          ],
          rules: [
            "- The event comprises of one rounds.",
            "- Tote Bag and materials will be provided by the organizers.",
            "- Participants will have to design the tote and present their product.",
            "- Participants can take their Tote Bag back with them.",
          ],
          price: ["- INR 150/-"],
          team: ["- Compulsory 2"],
        },
    ...
    data: [
      ...
      },
      {
        ...
        details: {
          ...
          rules: ["-  Design and draw a wall thickness plan for a public building in urban area. Auditorium for theatre (for live performance on stage)",
          "- Following are the requiremnets in the building being designed:",
          "  - PLOT SIZE : Upto Participants",
          "  - Parking (more than 30% of builtup area)",
          "  - Waiting Lounge ",
          "  - Food COurt",
          "  - Manager Cabin ",
          "  - Box Office",
          "  - Public toilet(male or female)",
          "  - Walking Passage",
          "  - Electrical Pumping room",
          "  - Viewer's gallery(Capacity more than 250)",
          "  - Stage and backstage [Includes:",
          "   i) Connectivity behind the stage from both side entries",
          "   ii) Dressing room for male and female. Dressing room includes:",
          "     a) Dressing area",
          ...
          "   iv) Meeting room",
          "   v) Passage",
          "   vi) backside seperate entry.",
          "- NOTICE: ",
          "  - Only one entry for viewers and 2 exits through the walkway.",
          "  - Participants are allowed to add 1 or 2 components if utmost necessary. ",
          "  - Width of space  0.6 m must be kept between rows of viewers. ",
          "  - Tentative dimensions and viewer's seat should be 0.75 × 0.85 m.",
          "  - Mention:",
          "   a) Proposed total builtup area in sq. m.",
          "   b) Parking area in sq. m.",
          "   c) Dimensions of each and every component in meters ",
