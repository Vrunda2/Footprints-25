import h1 from "../assets/history1.jpg";
import h2 from "../assets/image.jpg";
import h3 from "../assets/history2.jpg";
import h4 from "../assets/X1.jpg";
import h5 from "../assets/X2.jpg";
import h6 from "../assets/X3.jpg";
import h7 from "../assets/X4.jpg";
import h8 from "../assets/X5.jpg";
import h9 from "../assets/X8.jpg";
import h10 from "../assets/X10.jpg";
...
const HistoryData=[
...

    {
...

     {
      year:"24",
      heading:"BREAKING RECORDS",
      description:"FootPrints’24 was a groundbreaking celebration of innovation and excellence, surpassing every expectation and redefining what a technical event can achieve. With precise planning and an unwavering dedication to creating meaningful experiences, this edition showcased a dynamic blend of technical brilliance, captivating workshops, and enriching discussions that left an enduring impact on all who attended. The highlight of the event was an exhilarating live performance by world’s most loved Gujarati folk singer, lighting up the atmosphere and making it an unforgettable spectacle. With unprecedented participation, flawless organization, and glowing reviews from attendees, this edition firmly established itself as a milestone in our journey. FootPrints’24 was more than an event—it was a transformative experience that set a new standard for success and etched its name in history!",
      image:h14,
      }
